...
const TABLE = {
  ...
  '2-(acetyloxy)benzoic acid': ['aspirin', '아스피린', '해열 · 진통제. 살리실산의 OH 를 아세틸화'],
  ...
  '3-hydroxybutanal': ['aldol', '알돌', '알돌 반응의 이름이 된 분자 (aldehyde + alcohol)'],
